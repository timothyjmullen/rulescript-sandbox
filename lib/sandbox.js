...
function exRule(editor) {
    try {
        ...
        document.getElementById('exTime').innerHTML = '(' + (e - s).toFixed(4) + 'ms) <i class="fa fa-question-circle" id="time"><span class="tooltip" content="Over 1mm assemblies this would add approximately ' + hm(e-s) + ' to the launch time."></span></i>';
    } catch (e) {
